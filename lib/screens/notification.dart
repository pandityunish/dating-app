...
class Constants {
  ...
  static const String KEY_SERVER =
      'AAAAkBw0lvY:APA91bGA46casUdOefLu3bbZ68L0Vxcnf6d549p1CZd_8zx-P5XHOv4rmb0OVvTInjYlMVw1a2J5EstWbZHM8PnID7p60RUM_GuNCq7DP1BJCIfliRbyV5aVwcao0OceAFNeGA1YS1AC';
  static const String SENDER_ID = '618948499190';
}
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          Clipboard.setData(
                              ClipboardData(text: _textToken.text));
                        },
                      ),
                    )
                  ],
