...
class MessageText {
  ...
  static MessageText fromdoc(var doc) {
    MessageText txt = MessageText(
        text: doc.data().toString().contains('text') ? doc.get('text') : '',
        type: doc.data().toString().contains('type') ? doc.get('type') : '',
        status:
            doc.data().toString().contains('status') ? doc.get('status') : '',
        imgname:
            doc.data().toString().contains('imgname') ? doc.get('imgname') : '',
